...
class Paint(object):
    ...
    def __init__(self):
        ...
        self.p = Label(self.paint_tools, text="Kalem",borderwidth=0,font=('verdana',10,'bold'))
        ...
        self.b = Label(self.paint_tools,borderwidth=0,text='Fırça',font=('verdana',10,'bold'))
        ...
        self.cl = Label(self.paint_tools, text='Renkler',font=('verdana',10,'bold'))
        ...
        self.e = Label(self.paint_tools, text='Silgi',font=('verdana',10,'bold'))
        ...
        self.pen_size = Label(self.paint_tools,text="Kalem Boyutu",font=('verdana',10,'bold'))
