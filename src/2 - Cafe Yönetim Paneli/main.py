...
class macro():
        ...
        def __init__(self):
                ...
                self.root.title("Macro Was Here")
                self.root.maxsize(500,300)
                self.root.iconbitmap("cafe.ico")
                self.root.minsize(500,300)
                self.root['bg'] = "white"

                self.heading = Label(self.root,text="Cafe Yönetim Sistemi",font=('verdana',20,'bold'),fg="#248aa2",bg="white")
                ...
                self.frame1 = LabelFrame(self.root,text="Cafe Menüsü",width=150,height=200,font=('verdana',10,'bold'),borderwidth=3,relief=RIDGE,highlightthickness=4,bg="white",highlightcolor="white",highlightbackground="white",fg="#248aa2")
                self.frame1.place(x=30,y=90)
                
                self.tea = Label(self.frame1,text="Çay",font=('verdana',10,'bold'),bg="white")
                ...
                self.coffee = Label(self.frame1,text="Kavhe",font=('verdana',10,'bold'),bg="white")
                ...
                self.sandwitch = Label(self.frame1,text="Sandaviç",font=('verdana',10,'bold'),bg="white")
                ...
                self.cake = Label(self.frame1,text="Kek",font=('verdana',10,'bold'),bg="white")
                ...
                self.burger = Label(self.frame1,text="Hamburger",font=('verdana',10,'bold'),bg="white")
                ...
                self.fries = Label(self.frame1,text="Patates Kızartması",font=('verdana',10,'bold'),bg="white")
                ...
                self.frame2 = LabelFrame(self.root,text="Kasa",width=180,height=160,font=('verdana',10,'bold'),borderwidth=3,relief=RIDGE,highlightthickness=4,bg="white",highlightcolor="white",highlightbackground="white",fg="#248aa2")
                self.frame2.place(x=180,y=120)

                self.item_cost_lb = Label(self.frame2,text="Alınan Eşyalar",font=('verdana',10,'bold'),bg="white")
                ...
                self.service_cost_lb = Label(self.frame2,text="Servis Ücerti",font=('verdana',10,'bold'),bg="white")
                ...
                self.sub_cost_lb = Label(self.frame2,text="Alt Maliyat",font=('verdana',10,'bold'),bg="white")
                ...
                self.paid_tax_lb = Label(self.frame2,text="KDV - Vergi Ücreti",font=('verdana',10,'bold'),bg="white")
                ...
                self.total_bill_lb = Label(self.frame2,text="Toplam Tutar",font=('verdana',10,'bold'),bg="white")
                ...
                self.frame3 = LabelFrame(self.root,text="Hesap Makinası",font=('verdana',10,'bold'),fg="#248aa2",bg="white",highlightbackground="white",width=135,height=150,borderwidth=3,relief=RIDGE)
                ...
                self.Total_Bills_btn = Button(self.root,text="Hesapla",relief=RAISED,borderwidth=2,font=('verdana',10,'bold'),bg='#248aa2',fg="white",command=self.Total_Bill)
                self.Total_Bills_btn.place(x=360,y=245)
                
                self.Clear_btn = Button(self.root,text="Temizle",relief=RAISED,borderwidth=2,font=('verdana',10,'bold'),bg='#248aa2',fg="white",command=self.Clear)
