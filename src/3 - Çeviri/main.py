...
def translate():
        ...
        if language_1 == '':
                messagebox.showerror('Hata:','Lütfen Çevirmek istediğiniz Kelimeyi ya da Cümleyi Belirtin.')
        else:
                t2.delete(1.0,'end')
...
button = Button(root,text="Çevir",relief=RIDGE,borderwidth=3,font=('verdana',10,'bold'),cursor="hand2",command=translate)
button.place(x=150,y=280)


clear = Button(root,text="Temizle",relief=RIDGE,borderwidth=3,font=('verdana',10,'bold'),cursor="hand2",command=clear)
